...
Public Class StudentCard_7
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "STU_MS.StudentCard_7.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_paramSchoolName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStudentCard_7
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudentCard_7 = New StudentCard_7()
        rpt.Site = Me.Site
        Return rpt
    End Function
