Public Class frm_religion
    ...
    Private Sub Selection()
        ...
        Try
            obj.BindDataGridView("SELECT RELIGION_ID,ROW_NUMBER() OVER(ORDER BY RELIGION_ID asc) AS 'ROW_NUM', RELIGION_KH, RELIGION_EN FROM dbo.TBL_RELIGION", datagrid)
            datagrid.Columns(0).Visible = False
            datagrid.Columns(1).HeaderText = "ល.រ"
            datagrid.Columns(2).HeaderText = "សាសនា (KH)"
            datagrid.Columns(3).HeaderText = "សាសនា (EN) "
        ...
        Try
            If datagrid.SelectedRows.Count > 0 Then
                ...
                If USER_CLICK_OK = True Then
                    ...
                    obj.Delete("DELETE FROM  dbo.TBL_RELIGION WHERE  RELIGION_ID = " & datagrid.SelectedRows(0).Cells(0).Value & "")
