Public Class frm_langugae
    ...
    Private Sub Selection()
        ...
        Try
            obj.BindDataGridView("SELECT LANGUAGE_ID,ROW_NUMBER() OVER(ORDER BY LANGUAGE_ID asc) AS 'ROW_NUM',LANGUAGE_KH,LANGUAGE_EN FROM dbo.TBL_LANGUAGE", datagrid)
            datagrid.Columns(0).Visible = False
            datagrid.Columns(1).HeaderText = "ល.រ"
            datagrid.Columns(2).HeaderText = "ភាសា (KH)"
            datagrid.Columns(3).HeaderText = "ភាសា (EN) "
        ...
        Try
            If datagrid.SelectedRows.Count > 0 Then
                ...
                If USER_CLICK_OK = True Then
                    ...
                    obj.Delete("DELETE FROM  dbo.TBL_LANGUAGE WHERE  LANGUAGE_ID = " & datagrid.SelectedRows(0).Cells(0).Value & "")
