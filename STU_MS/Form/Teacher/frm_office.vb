Public Class frm_office
    ...
    Private Sub Selection()
        ...
        Try
            obj.BindDataGridView("SELECT OFFICE_ID,ROW_NUMBER() OVER(ORDER BY OFFICE_ID asc) AS 'ROW_NUM', OFFICE_CODE, OFFICE_KH FROM dbo.TBL_OFFICE", datagrid)

            datagrid.Columns(0).Visible = False
            datagrid.Columns(1).HeaderText = "ល.រ"
            datagrid.Columns(2).HeaderText = "លេខសម្គាល់"
            datagrid.Columns(3).HeaderText = "ការិយាល័យ"
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        Try
            If txt_code.Text = "" Or txt_office_kh.Text = "" Then
        ...
        Try
            If datagrid.SelectedRows.Count > 0 Then
                ...
                If USER_CLICK_OK = True Then
                    obj.Delete("DELETE FROM  dbo.TBL_OFFICE WHERE  OFFICE_ID = " & datagrid.SelectedRows(0).Cells(0).Value & "")
    ...
    Private Sub datagrid_SelectionChanged(sender As Object, e As EventArgs) Handles datagrid.SelectionChanged
        ...
        Try
            ...
            txt_code.Text = datagrid.SelectedRows(0).Cells(2).Value
            txt_office_kh.Text = datagrid.SelectedRows(0).Cells(3).Value
        Catch ex As Exception
